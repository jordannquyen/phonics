...
class PricingBoxThree extends React.Component<Props,State> {
    render() {
        const all = {
        ...
        return (
            <div style={all}>
                <h3 style={{paddingTop: '20px', marginBottom: '10px'}}>Huge</h3>
                <h1 style={{marginTop: '0', marginBottom: '10px'}}>$7</h1>
